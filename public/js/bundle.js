...
var showAlert = function showAlert(type, message) {
  ...
  markup.classList.add("alert--".concat(type));
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaWdvcmdvbmNoYXIiLCJhIjoiY2s5b216M21mMDI2czNocG53d3phbHN5eiJ9.Pdf_p0EaI5BdXxeQ5OY7lw';
  var map = new mapboxgl.Map({
    container: 'map',
    // will put map on element with id 'map'
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p> ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map);
...
var stripe = Stripe('pk_test_QcqUhZwc8wXFQXRrgkuVlnRx00wL9Iri73');
...
if (updateUserInfoForm) {
  updateUserInfoForm.addEventListener('submit', function (event) {
    event.preventDefault();
    var form = new FormData(); // for multipart form data
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              tourId = e.target.dataset.tourId; // converted from attribute: 'data-tour-id'
...
if (alertMessage) {
  (0, _alerts.showAlert)('success', alertMessage, 15);
}
},{"./login":"login.js","./signup":"signup.js","./update-settings":"update-settings.js","./mapbox":"mapbox.js","./stripe":"stripe.js","./alerts":"alerts.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
